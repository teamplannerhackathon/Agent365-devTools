...
public class GraphApiService
{
        ...
        IEnumerable<string>? authScopes = null)
    {
        ...
        if (existing is null)
        {
            ...
            var created = await GraphPostAsync(tenantId, "/v1.0/oauth2PermissionGrants", payload, ct, authScopes);
        ...
        return await GraphPatchAsync(tenantId, $"/v1.0/oauth2PermissionGrants/{id}", new { scope = merged }, ct, authScopes);
    }
